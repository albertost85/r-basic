---
title: Funciones para ordenar los datos de un vector en R
author: Author Name
header: R01V06
...
---
### ```sort(x)```
- Ordena el vector en orden natural de los objetos que lo forman: el orden numérico creciente, orden alfabético...
- Parámetros
  - ```decreasing = TRUE``` ordena e invierte el orden.

### ```rev(x)```
- Invierte el orden de los elementos del vector $x$.
